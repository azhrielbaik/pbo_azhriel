...
class database{
    ...
    // ... (Fungsi cek_login, tampil_data, cari_data_barang, dll. biarkan saja) ...
    ...
    function tambah_data($kd_barang, $nama_barang, $stok, $harga_beli, $harga_jual, $gambar_produk)
    {
        ...
        if (!empty($gambar_produk['name'])) {
            ...
            if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
                ...
                return false; // Hentikan eksekusi jika ekstensi salah
            }
        }
        
        // Hapus 'id_barang' dari query INSERT karena itu auto_increment
    ...
    // ===================================================================
    // == FUNGSI PENTING: EDIT DATA BARANG
    // ===================================================================
    ...
    // ... (Fungsi customer, supplier, dan hitung data biarkan saja) ...
